...
export default function InquiryForm() {
  ...
  return (
    <section id="inquiry" className="py-24 lg:py-40 bg-[#0B1220] border-t border-white/5 w-full overflow-hidden text-white">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:w-5/12 flex flex-col justify-between">
            ...
            <div className="mt-20 lg:mt-32 pt-8 border-t border-white/10">
              ...
              <a href="mailto:teamacumo@gmail.com" className="text-xl font-bold tracking-tight text-white hover:text-white/50 transition-colors">
                teamacumo@gmail.com
              </a>
            </div>
          </div>
          ...
          <div className="lg:w-7/12 mt-8 lg:mt-0">
            <div className="bg-[#070D16] rounded-[5px] p-8 md:p-12 lg:p-16 shadow-[0_10px_40px_rgba(7,13,22,0.5)] border border-white/5 relative">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#2563FF] via-[#60A5FA]/40 to-transparent opacity-30"></div>
